...
internal fun localizedAndroidKitStrings(): AndroidKitStrings = AndroidKitStrings(
    ...
    supportTitle = stringResource(R.string.androidkit_compose_support_title),
    supportDescription = stringResource(R.string.androidkit_compose_support_description),
    ...
    appInfo = stringResource(R.string.androidkit_compose_app_info),
    app = stringResource(R.string.androidkit_compose_app),
    ...
    projectRepository = stringResource(R.string.androidkit_compose_project_repository),
    license = stringResource(R.string.androidkit_compose_license),
    contribute = stringResource(R.string.androidkit_compose_contribute),
)
