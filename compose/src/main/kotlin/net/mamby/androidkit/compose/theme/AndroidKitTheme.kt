...
internal data class AndroidKitStrings(
    ...
    val confirm: String,
    val save: String,
    val hideTitleBar: String,
    val showTitleBar: String,
    val general: String,
    val language: String,
    val theme: String,
    ...
    val noMatchingLanguages: String,
    val system: String,
    val security: String,
    val appLock: String,
    val lockAfterLeavingApp: String,
    val immediately: String,
    val afterOneMinute: String,
    val afterFiveMinutes: String,
    val afterFifteenMinutes: String,
    val lockNow: String,
    ...
    val thirdPartyLicensesDescription: String,
    val supportPromptTitle: String,
    val supportPromptDescription: String,
    val supportPromptLearnMore: String,
    val supportPromptNotNow: String,
    val supportPromptDonate: String,
)
...
public object AndroidKitThemeTokens {
    ...
    internal val strings: AndroidKitStrings
        @Composable
        @ReadOnlyComposable
