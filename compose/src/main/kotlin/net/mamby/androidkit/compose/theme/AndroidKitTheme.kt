...
public data class AndroidKitDimensions(
    ...
    public val floatingNavigationOverflowItemHorizontalPadding: Dp = 12.dp,
...
public data class AndroidKitStrings(
    ...
    public val general: String = "General",
    public val language: String = "Language",
    public val theme: String = "Theme",
    public val transparency: String = "Transparency",
    public val min: String = "Min",
    public val max: String = "Max",
    public val searchLanguages: String = "Search languages",
    public val noMatchingLanguages: String = "No matching languages",
    public val system: String = "System",
    public val security: String = "Security",
    public val appLock: String = "App lock",
    public val lockAfterLeavingApp: String = "Lock after leaving the app",
    public val immediately: String = "Immediately",
    public val afterOneMinute: String = "After 1 minute",
    public val afterFiveMinutes: String = "After 5 minutes",
    public val afterFifteenMinutes: String = "After 15 minutes",
    public val lockNow: String = "Lock now",
    public val supportTitle: String = "Support this app",
    public val supportDescription: String = "Help support continued development.",
    public val about: String = "About",
    public val version: String = "Version",
    public val openSource: String = "Open source",
    public val contact: String = "Contact",
    public val appInfo: String = "App info",
    public val app: String = "App",
    public val privacyPolicy: String = "Privacy policy",
    public val termsOfUse: String = "Terms of use",
    public val thirdPartyLicenses: String = "Third-party licenses",
    public val sourceCode: String = "Source code",
    public val license: String = "License",
    public val contributors: String = "Contributors",
) {
    public companion object {
        public val English: AndroidKitStrings = AndroidKitStrings(
            ...
            security = "Security",
            appLock = "App lock",
            lockAfterLeavingApp = "Lock after leaving the app",
            immediately = "Immediately",
            afterOneMinute = "After 1 minute",
            afterFiveMinutes = "After 5 minutes",
            afterFifteenMinutes = "After 15 minutes",
            lockNow = "Lock now",
            supportTitle = "Support this app",
            supportDescription = "Help support continued development.",
            about = "About",
            version = "Version",
