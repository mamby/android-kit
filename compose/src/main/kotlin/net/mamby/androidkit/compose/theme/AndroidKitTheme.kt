...
public data class AndroidKitStrings(
    ...
    public val supportTitle: String = "Support open-source development",
    public val supportDescription: String = "Help maintain, test, and improve Android Kit.",
    public val getInvolved: String = "Get involved",
    public val about: String = "About",
    public val version: String = "Version",
    public val openSource: String = "Open source",
    public val information: String = "Information",
) {
    public companion object {
        public val English: AndroidKitStrings = AndroidKitStrings(
            ...
            lockNow = "Lock now",
            supportTitle = "Support open-source development",
            supportDescription = "Help maintain, test, and improve Android Kit.",
